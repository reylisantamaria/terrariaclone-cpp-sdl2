...
set(libdir "/opt/homebrew/Cellar/sdl2_image/2.8.4/lib")
set(_sdl2image_extra_static_libraries "-L/opt/homebrew/opt/libpng/lib -lpng16 -L/opt/homebrew/opt/jpeg-xl/lib -ljxl -L/opt/homebrew/opt/jpeg-turbo/lib -ljpeg -L/opt/homebrew/opt/libtiff/lib -ltiff -L/opt/homebrew/Cellar/libavif/1.1.1/lib -lavif -L/opt/homebrew/opt/webp/lib -lwebpdemux -L/opt/homebrew/opt/webp/lib -lwebp  ")
